        ...
        return to_mcp_result(success(request_context.request_id, {
            ...
            "economy_mode": {
                ...
                "rules": [
                    ...
                    "For multi-step work that merits user-visible progress, use bridge_call for work_progress_update at task start and refresh it only at meaningful milestones or final state; never update progress per tool call.",
