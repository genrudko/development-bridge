        ...
        return to_mcp_result(success(request_context.request_id, {
            ...
            "durable_jobs": {
                ...
                "preferred_event_flow": [
                    ...
                    "read terminal job_status and job_output once",
                ],
            },
            "operator_guidance": {
                ...
                "coordinator": "Mount coordinator_x_mount in the chat/channel before coordinator_continue or coordinator_wake_on_jobs. Resilient job continuations retry X delivery until exact continuation ACK, then escalate to Telegram after 3 unacknowledged attempts; the pre-terminal job waiter is durable across Bridge restart. Write continuation message as a short user-facing status in the current conversation language; technical IDs/reason stay hidden by the coordinator UI.",
